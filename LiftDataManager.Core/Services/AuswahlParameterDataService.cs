...
public class AuswahlParameterDataService : IAuswahlParameterDataService
{
    ...
    public async Task<string> UpdateAuswahlparameterAsync()
    {
        ...
        string[,] importAusawahlParameter =
        {
            ...
            { "Daten Türen", "Türtyp","var_Tuertyp_B" },
            { "Daten Türen", "Türtyp","var_Tuertyp_C" },
            { "Daten Türen", "Türtyp","var_Tuertyp_D" },
            { "Daten Türen", "Meiller","var_Tuerbezeichnung" },
            { "Daten Türen", "Meiller","var_Tuerbezeichnung_B" },
            { "Daten Türen", "Meiller","var_Tuerbezeichnung_C" },
            { "Daten Türen", "Meiller","var_Tuerbezeichnung_D" },
            ...
            { "Daten Türen", "Türöffnung","var_Tueroeffnung_B" },
            { "Daten Türen", "Türöffnung","var_Tueroeffnung_C" },
            { "Daten Türen", "Türöffnung","var_Tueroeffnung_D" },
            ...
            { "Daten Türen", "Schwellenprofile","var_SchwellenprofilKabTuere" },
            { "Daten Türen", "Türzulassung","var_ZulassungTuere" },
            { "Daten Türen", "Türzulassung","var_ZulassungTuere_B" },
            { "Daten Türen", "Türzulassung","var_ZulassungTuere_C" },
            { "Daten Türen", "Türzulassung","var_ZulassungTuere_D" },
