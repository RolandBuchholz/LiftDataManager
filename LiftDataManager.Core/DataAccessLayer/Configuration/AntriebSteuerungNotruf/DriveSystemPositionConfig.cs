...
public class DriveSystemPositionConfig : BaseModelBuilder<DriveSystemPosition>
{
    public override void Configure(EntityTypeBuilder<DriveSystemPosition> builder)
    {
