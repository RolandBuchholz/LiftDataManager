...
public class LiftSafetyComponent(string safetyType, string manufacturer, string model, string certificateNumber, string safetyComponentTyp, string specialOption = "")
{
