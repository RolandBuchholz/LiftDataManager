...
public class SpezifikationDocument : PdfBaseDocument
{
    ...
    void CarFrameDetailData(IContainer container)
    {
        container.Table(table =>
        {
            ...
            table.Cell().Row(10).Column(1).Text($"Gegengewicht kompl. (Ausgleich {ParameterDictionary["var_GGWNutzlastausgleich"].Value}):").FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(2).AlignRight().Text(ParameterDictionary["var_Gegengewichtsmasse"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(3).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(1).Text("GGW-Rahmengewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(2).AlignRight().Text(ParameterDictionary["var_GGW_Rahmen_Gewicht"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(3).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(1).Text("GGW-Füllungsgewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(2).AlignRight().Text(ParameterDictionary["var_GGW_Fuellgewicht"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(3).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(14).Column(1).Text("Schienenlänge Gegengewicht:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(16).Column(1).Text("Startschiene Gegengewicht:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(18).Column(1).Text("Gegengewicht Endstück:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(20).Column(1).Text("Treibscheibendurchmesser:").FontSize(fontSizeXXS);
            table.Cell().Row(20).Column(2).AlignRight().Text(ParameterDictionary["var_Treibscheibendurchmesser"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(20).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
