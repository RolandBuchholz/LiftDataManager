...
public class SpezifikationDocument : PdfBaseDocument
{
        ...
        container.Row(row =>
        {
            ...
            row.RelativeItem(6).PaddingLeft(3).Height(boxHeight + 3).Layers(layers =>
            {
                ...
                layers.Layer().PaddingLeft(5).Table(table =>
                {
                    ...
                    table.Cell().Row(2).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_Firma"].Value);
                    table.Cell().Row(3).Column(1).Text("Name Auftraggeber:");
                    table.Cell().Row(3).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonZ1"].Value);
                    table.Cell().Row(4).Column(1).Text("Straße Hausnummer:");
                    table.Cell().Row(4).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonZ2"].Value);
                    table.Cell().Row(5).Column(1).Text("Postleitzahl Ort:");
                    table.Cell().Row(5).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonZ3"].Value);
                    table.Cell().Row(6).Column(1).Text("Fachplaner:");
                    table.Cell().Row(6).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonZ4"].Value);
                    table.Cell().Row(7).Column(1).Text("Adresse Fachplaner:");
                    table.Cell().Row(7).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_FP_Adresse"].Value);
                    table.Cell().Row(8).Column(1).Text("Telefon Fachplaner:");
                    table.Cell().Row(8).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonPhone"].Value);
                    table.Cell().Row(9).Column(1).Text("Mobiltelefon Fachplaner:");
                    table.Cell().Row(9).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonMobil"].Value);
                    table.Cell().Row(10).Column(1).Text("E-Mail Fachplaner:");
                    table.Cell().Row(10).Column(2).PaddingRight(2).BorderBottom(0.1f).BorderColor(primaryVariantColor).Text(ParameterDictionary["var_AnPersonMail"].Value);
                });
            });
        });
    }
    ...
    void CarData(IContainer container)
    {
        container.PaddingTop(3).Layers(layers =>
        {
            ...
            layers.PrimaryLayer().Table(table =>
            {
                ...
                table.Cell().Row(11).Column(3).ColumnSpan(2).ParameterStringCell(ParameterDictionary["var_Eingangswand"]);
                table.Cell().Row(11).Column(5).ParameterBoolCell(ParameterDictionary["var_BelueftungHals"]);
    ...
    void CarDataDetail(IContainer container)
    {
        container.PaddingTop(3).Layers(layers =>
        {
            ...
            layers.PrimaryLayer().Table(table =>
            {
                ...
                table.Cell().Row(17).RowSpan(2).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Zusatzausstattung").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(17).Column(3).ParameterBoolCell(ParameterDictionary["var_VentilatorLuftmenge"], false, "Ventilator 90 m³/h");
                table.Cell().Row(17).Column(4).ParameterStringCell(ParameterDictionary["var_VentilatorAnzahl"], "Stk", true);
                table.Cell().Row(17).Column(5).ColumnSpan(2).ParameterStringCell(ParameterDictionary["var_VentilatorEinbau"]);
                table.Cell().Row(18).Column(3).ParameterBoolCell(ParameterDictionary["var_KabBauschutz"]);
                table.Cell().Row(18).Column(4).ColumnSpan(3).ParameterBoolCell(ParameterDictionary["var_KabSchutzvorhang"]);
                table.Cell().Row(19).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Sonstiges Fahrkorb").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(19).Column(3).ColumnSpan(4).ParameterStringCell(ParameterDictionary["var_SonstigesFahrkorb"], null, true, true);
            });
        });
    }
    ...
    void LiftDoorData(IContainer container)
    {
        container.PaddingTop(3).Layers(layers =>
        {
            ...
            layers.PrimaryLayer().Table(table =>
            {
                ...
                bool showShaftDoorDetails = !LiftParameterHelper.GetLiftParameterValue<bool>(ParameterDictionary, "var_SchachttuereBestand");
                bool showCarDoorDetails = !LiftParameterHelper.GetLiftParameterValue<bool>(ParameterDictionary, "var_KabinentuereBestand");

                table.Cell().Row(1).Column(1).RowSpan(39).RotateLeft().AlignMiddle().AlignCenter().Text("Türen").FontColor(borderColor).Bold();
                ...
                table.Cell().Row(15).Column(2).RowSpan(4).ShowIf(showShaftDoorDetails).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Schwellen").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(15).Column(3).ColumnSpan(2).ShowIf(showShaftDoorDetails).ParameterStringCell(ParameterDictionary["var_Schwellenprofil"], null, false, false, variableDoorData ? "Schwellenprofil Schachttüre Zugang A" : "Schwellenprofil Schachttüre(n)");
                table.Cell().Row(15).Column(5).ColumnSpan(2).RowSpan(4).ShowIf(showShaftDoorDetails).ParameterStringCell(ParameterDictionary["var_AnmerkungSchwelleST"]);
                table.Cell().Row(16).Column(3).ColumnSpan(2).ShowIf(entranceB && variableDoorData && showShaftDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilB"]);
                table.Cell().Row(17).Column(3).ColumnSpan(2).ShowIf(entranceC && variableDoorData && showShaftDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilC"]);
                table.Cell().Row(18).Column(3).ColumnSpan(2).ShowIf(entranceD && variableDoorData && showShaftDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilD"]);
                table.Cell().Row(19).RowSpan(7).Column(2).ShowIf(showShaftDoorDetails).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Schachttür Optionen").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(19).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).Row(row =>
                {
                ...
                table.Cell().Row(20).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).Row(row =>
                {
                ...
                table.Cell().Row(21).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).Row(row =>
                {
                    row.RelativeItem(1).ParameterBoolCell(ParameterDictionary["var_Estrichbleche"]);
                    row.RelativeItem(1).ParameterBoolCell(ParameterDictionary["var_TuerSchauOeffnungST"]);
                    row.RelativeItem(1).ParameterCustomBoolCell(ParameterDictionary["var_BenDef_53"]);

                });
                table.Cell().Row(22).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).Row(row =>
                {
                ...
                table.Cell().Row(23).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).Row(row =>
                {
                ...
                table.Cell().Row(24).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).Row(row =>
                {
                ...
                table.Cell().Row(25).Column(3).ColumnSpan(4).ShowIf(showShaftDoorDetails).ParameterCustomBoolCell(ParameterDictionary["var_BenDef_5"]);
                table.Cell().Row(26).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Sonstiges Schachttüren").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(26).Column(3).ColumnSpan(4).ParameterStringCell(ParameterDictionary["var_SonstigesSchachttuere"], null, true, true);
                //Kabinentüren
                table.Cell().Row(27).Column(2).ColumnSpan(5).PaddingLeft(0.25f).PaddingRight(0.75f).Background(secondaryColor).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text(showCarDoorDetails ? "Kabinentüren" : "Bestands Kabinentüren werden weiterverwendet").FontSize(fontSizeXS).FontColor(onPrimaryVariantColor).Bold();
                table.Cell().Row(28).RowSpan(2).Column(2).ShowIf(showCarDoorDetails).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Antrieb").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(28).Column(3).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_Tuersteuerung"]);
                table.Cell().Row(28).Column(5).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_ErgAnTuere"]);
                table.Cell().Row(29).Column(3).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_Lichtgitter"]);
                table.Cell().Row(29).Column(5).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_Tuerverriegelung"]);
                table.Cell().Row(30).Column(2).ShowIf(showCarDoorDetails).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Material").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(30).Column(3).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_OberflaecheKabinentuere"]);
                table.Cell().Row(30).Column(5).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_RalKabinentuere"]);
                table.Cell().Row(31).Column(2).RowSpan(4).ShowIf(showCarDoorDetails).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Schwellen").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(31).Column(3).ColumnSpan(2).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilKabTuere"], null, false, false, variableDoorData ? "Schwellenprofil Kabinentüre Zugang A" : "Schwellenprofil Kabinentür(en)");
                table.Cell().Row(31).Column(5).ColumnSpan(2).RowSpan(4).ShowIf(showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_AnmerkungSchwelleKT"]);
                table.Cell().Row(32).Column(3).ColumnSpan(2).ShowIf(entranceB && variableDoorData && showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilKabTuereB"]);
                table.Cell().Row(33).Column(3).ColumnSpan(2).ShowIf(entranceC && variableDoorData && showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilKabTuereC"]);
                table.Cell().Row(34).Column(3).ColumnSpan(2).ShowIf(entranceD && variableDoorData && showCarDoorDetails).ParameterStringCell(ParameterDictionary["var_SchwellenprofilKabTuereD"]);
                table.Cell().Row(35).RowSpan(4).Column(2).ShowIf(showCarDoorDetails).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Kabinentür Optionen").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(35).Column(3).ColumnSpan(4).ShowIf(showCarDoorDetails).Row(row =>
                {
    ...
    void LiftControlerData(IContainer container)
    {
        container.PaddingTop(3).Layers(layers =>
        {
            ...
            layers.PrimaryLayer().Table(table =>
            {
                ...
                table.Cell().Row(1).Column(1).RowSpan(17).RotateLeft().AlignMiddle().AlignCenter().Text("Steuerung").FontColor(borderColor).Bold();
                table.Cell().Row(1).RowSpan(13).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Steuerung/ELT").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                ...
                table.Cell().Row(5).Column(3).ColumnSpan(4).Row(row =>
                {
                    row.RelativeItem().ParameterBoolCell(ParameterDictionary["var_Schwellenbeleuchtung"]);
                    row.RelativeItem().ParameterBoolCell(ParameterDictionary["var_StSchwellenheizung"]);
                    row.RelativeItem().ParameterBoolCell(ParameterDictionary["var_KtSchwellenheizung"]);
                });
                table.Cell().Row(6).Column(3).ColumnSpan(4).Row(row =>
                {
                ...
                table.Cell().Row(10).Column(3).ColumnSpan(4).Row(row =>
                {
                    ...
                    row.RelativeItem().ParameterBoolCell(ParameterDictionary["var_HasOilbuffer"]);
                ...
                {
                    row.RelativeItem().ParameterBoolCell(ParameterDictionary["var_HasCwtSafetyGear"]);
                    row.RelativeItem(2).ParameterCustomBoolCell(ParameterDictionary["var_BenDef_17"]);
                });
                table.Cell().Row(14).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Stromanschluss").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                ...
                table.Cell().Row(15).RowSpan(2).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Schaltschrank").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(15).Column(3).ColumnSpan(4).Row(row =>
                {
                ...
                table.Cell().Row(16).Column(3).ColumnSpan(4).ParameterStringCell(ParameterDictionary["var_Schaltschrankgroesse"]);
                table.Cell().Row(17).Column(2).BorderBottom(0.1f).BorderColor(borderColor).PaddingLeft(5).AlignMiddle().Text("Sonstiges Steuerung").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(17).Column(3).ColumnSpan(4).MinHeight(30).ParameterStringCell(ParameterDictionary["var_SonstigesSteuerung"], null, true, true);
            });
        });
    }
    ...
    void CarFrameDetailData(IContainer container)
    {
        container.Table(table =>
        {
            ...
            var isRopeLift = _calculationsModuleService.IsRopeLift(ParameterDictionary["var_Bausatz"].DropDownListValue);
            ...
            table.Cell().Row(8).Column(2).AlignRight().Text(ParameterDictionary["var_Puffertyp"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(9).Column(1).ShowIf(isRopeLift).Text("Puffer Typ GGW:").FontSize(fontSizeXXS);
            table.Cell().Row(9).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_Puffertyp_GGW"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(1).Text("Fangrahmengewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(2).AlignRight().Text($"{_calculationsModuleService.GetCarFrameWeight(ParameterDictionary)}").FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(3).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(1).ShowIf(isRopeLift).Text($"Gegengewicht kompl. (Ausgleich {ParameterDictionary["var_GGWNutzlastausgleich"].Value}):").FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_Gegengewichtsmasse"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(1).ShowIf(isRopeLift).Text("GGW-Rahmengewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_GGW_Rahmen_Gewicht"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(13).Column(1).ShowIf(isRopeLift).Text("GGW-Füllungsgewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(13).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_GGW_Fuellgewicht"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(13).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(14).Column(1).Text("Schienenlänge Fahrkorb:").FontSize(fontSizeXXS);
            table.Cell().Row(14).Column(2).AlignRight().Text(ParameterDictionary["var_Schienenlaenge"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(14).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(15).Column(1).Text(isRopeLift ? "Schienenlänge Gegengewicht:" : "Jochschienenlänge:").FontSize(fontSizeXXS);
            table.Cell().Row(15).Column(2).AlignRight().Text(ParameterDictionary["var_Hilfsschienenlaenge"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(15).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(16).Column(1).Text("Startschiene Fahrkorb:").FontSize(fontSizeXXS);
            table.Cell().Row(16).Column(2).AlignRight().Text(ParameterDictionary["var_Startschiene"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(16).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(17).Column(1).Text(isRopeLift ? "Startschiene Gegengewicht:" : "Startschiene Joch").FontSize(fontSizeXXS);
            table.Cell().Row(17).Column(2).AlignRight().Text(ParameterDictionary["var_HilfsschienenlaengeStartstueck"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(17).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(18).Column(1).Text("Fahrkorb Endstück:").FontSize(fontSizeXXS);
            table.Cell().Row(18).Column(2).AlignRight().Text(ParameterDictionary["var_Endschiene"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(18).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(19).Column(1).Text(isRopeLift ? "Gegengewicht Endstück:" : "Joch Endstück").FontSize(fontSizeXXS);
            table.Cell().Row(19).Column(2).AlignRight().Text(ParameterDictionary["var_HilfsschienenlaengeEndstueck"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(19).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(20).Column(1).ColumnSpan(3).PaddingTop(3).Text("Seildaten").FontSize(fontSizeXS).FontColor(borderColor).Bold();
            table.Cell().Row(21).Column(1).ShowIf(isRopeLift).Text("Treibscheibendurchmesser:").FontSize(fontSizeXXS);
            table.Cell().Row(21).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_Treibscheibendurchmesser"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(21).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(22).Column(1).ColumnSpan(3).Text($"Tragseiltyp:   {ParameterDictionary["var_Tragseiltyp"].Value}").FontSize(fontSizeXXS);
            table.Cell().Row(23).Column(1).Text("Anzahl der Tragseile:").FontSize(fontSizeXXS);
            table.Cell().Row(23).Column(2).AlignRight().Text(ParameterDictionary["var_NumberOfRopes"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(23).Column(3).AlignLeft().PaddingLeft(2).Text("stk.").FontSize(fontSizeXXS);
            table.Cell().Row(24).Column(1).Text("Mindestbruchlast Tragseil:").FontSize(fontSizeXXS);
            table.Cell().Row(24).Column(2).AlignRight().Text(ParameterDictionary["var_Mindestbruchlast"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(24).Column(3).AlignLeft().PaddingLeft(2).Text("N").FontSize(fontSizeXXS);
            table.Cell().Row(25).Column(1).Text("Sicherheitsfaktor Tragseil:").FontSize(fontSizeXXS);
            table.Cell().Row(25).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_RopeSafety"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(26).Column(1).ColumnSpan(3).PaddingTop(3).Text("Belastungen / Kräfte").FontSize(fontSizeXS).FontColor(borderColor).Bold();
            table.Cell().Row(27).Column(1).Text("Belastung unter FK Schiene:").FontSize(fontSizeXXS);
            table.Cell().Row(27).Column(2).AlignRight().Text($"({ParameterDictionary["var_Belastung_pro_Schiene_auf_Grundelement"].Value}) {ParameterDictionary["var_Belastung_pro_Schiene_auf_Grundelement_AZ"].Value}").FontSize(fontSizeXXS);
            table.Cell().Row(27).Column(3).AlignLeft().PaddingLeft(2).Text("N").FontSize(fontSizeXXS);
            table.Cell().Row(28).Column(1).ShowIf(isRopeLift).Text("Belastung unter GGW Schiene:").FontSize(fontSizeXXS);
            table.Cell().Row(28).Column(2).ShowIf(isRopeLift).AlignRight().Text($"({ParameterDictionary["var_Belastung_pro_Schiene_auf_Grundelement_GGW"].Value}) {ParameterDictionary["var_Belastung_pro_Schiene_auf_Grundelement_GGW_AZ"].Value}").FontSize(fontSizeXXS);
            table.Cell().Row(28).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("N").FontSize(fontSizeXXS);
            table.Cell().Row(29).Column(1).Text("Belastung unter FK Puffer:").FontSize(fontSizeXXS);
            table.Cell().Row(29).Column(2).AlignRight().Text($"({ParameterDictionary["var_Belastung_Pufferstuetze_auf_Grundelement"].Value}) {ParameterDictionary["var_Belastung_Pufferstuetze_auf_Grundelement_AZ"].Value}").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(36).Column(1).Text($"Nennstrom Netz ({ParameterDictionary["var_ZA_IMP_Nennstrom"].Value}A aufgerundet + 10A):").FontSize(fontSizeXXS);
            table.Cell().Row(36).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Nennstrom_AZ"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(36).Column(3).AlignLeft().PaddingLeft(2).Text("A").FontSize(fontSizeXXS);
            table.Cell().Row(37).Column(1).Text($"Max. Netzstromaufnahme ({ParameterDictionary["var_ZA_IMP_Nennstrom"].Value}A x 1,8 + 10A):").FontSize(fontSizeXXS);
            table.Cell().Row(37).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_AnlaufstromMax"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(37).Column(3).AlignLeft().PaddingLeft(2).Text("A").FontSize(fontSizeXXS);
            table.Cell().Row(38).Column(1).Text($"Leistung Netz ({ParameterDictionary["var_ZA_IMP_Leistung"].Value}kW aufgerundet + 2kW):").FontSize(fontSizeXXS);
            table.Cell().Row(38).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Leistung_AZ"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(38).Column(3).AlignLeft().PaddingLeft(2).Text("KW").FontSize(fontSizeXXS);
            table.Cell().Row(39).Column(1).Text("Spannung Netz:").FontSize(fontSizeXXS);
            table.Cell().Row(39).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Stromart"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(39).Column(3).AlignLeft().PaddingLeft(2).Text("V").FontSize(fontSizeXXS);
            table.Cell().Row(40).Column(1).Text("Leistung Motor:").FontSize(fontSizeXXS);
            table.Cell().Row(40).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Motor_Pr"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(40).Column(3).AlignLeft().PaddingLeft(2).Text("KW").FontSize(fontSizeXXS);
            table.Cell().Row(41).Column(1).Text("Bemessungsspannung Motor:").FontSize(fontSizeXXS);
            table.Cell().Row(41).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Motor_Ur"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(41).Column(3).AlignLeft().PaddingLeft(2).Text("V").FontSize(fontSizeXXS);
            table.Cell().Row(42).Column(1).Text("Bemessungsstrom Motor:").FontSize(fontSizeXXS);
            table.Cell().Row(42).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Motor_Ir"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(42).Column(3).AlignLeft().PaddingLeft(2).Text("A").FontSize(fontSizeXXS);
            table.Cell().Row(43).Column(1).Text("Motorstrom bei Maximalmoment:").FontSize(fontSizeXXS);
            table.Cell().Row(43).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Motor_Strom_Maximalmoment"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(43).Column(3).AlignLeft().PaddingLeft(2).Text("A").FontSize(fontSizeXXS);
            table.Cell().Row(44).Column(1).Text("Verlustleistung:").FontSize(fontSizeXXS);
            table.Cell().Row(44).Column(2).ColumnSpan(2).AlignRight().PaddingRight(2).Text(ParameterDictionary["var_ZA_IMP_VerlustLeistung"].Value).FontSize(fontSizeXXS);
            var maxFuse = _calculationsModuleService.GetMaxFuse(ParameterDictionary["var_ZA_IMP_Regler_Typ"].Value);
            table.Cell().Row(45).Column(1).Text("Max. Schmelzsicherung:").FontSize(fontSizeXXS);
            table.Cell().Row(45).Column(2).AlignRight().Text(maxFuse.ToString()).FontSize(fontSizeXXS);
            table.Cell().Row(45).Column(3).AlignLeft().PaddingLeft(2).Text("A").FontSize(fontSizeXXS);
        });
    }
    ...
    void DriveDetailData(IContainer container)
    {
        container.Table(table =>
        {
            ...
            var isRopedrive = string.IsNullOrWhiteSpace(ParameterDictionary["var_Getriebe"].Value) || ParameterDictionary["var_Getriebe"].Value != "hydraulisch";
            if (isRopedrive)
            {
                ...
                table.Cell().Row(3).Column(1).ColumnSpan(2).Text($"Treibscheibe {ParameterDictionary["var_LageAntrieb"].Value}, {ParameterDictionary["var_SeilabgangAntrieb"].Value}").FontSize(fontSizeXXS);
                table.Cell().Row(4).Column(1).Text("Aufhängung:").FontSize(fontSizeXXS);
                table.Cell().Row(4).Column(2).AlignRight().Text($"{ParameterDictionary["var_AufhaengungsartRope"].Value} : 1").FontSize(fontSizeXXS);
                table.Cell().Row(5).Column(1).Text("Umschlingungswinkel:").FontSize(fontSizeXXS);
                table.Cell().Row(5).Column(2).AlignRight().Text($"{ParameterDictionary["var_Umschlingungswinkel"].Value} grad").FontSize(fontSizeXXS);
                table.Cell().Row(6).Column(1).Text("Treibscheibendurchmesser:").FontSize(fontSizeXXS);
                table.Cell().Row(6).Column(2).AlignRight().Text($"{ParameterDictionary["var_Treibscheibendurchmesser"].Value} mm (RA :{ParameterDictionary["var_ZA_IMP_Treibscheibe_RIA"].Value} mm)").FontSize(fontSizeXXS);
                table.Cell().Row(7).Column(1).Text("Umlenkrollendurchmesser:").FontSize(fontSizeXXS);
                table.Cell().Row(7).Column(2).AlignRight().Text($"{ParameterDictionary["var_Umlenkrollendurchmesser"].Value} mm").FontSize(fontSizeXXS);
                table.Cell().Row(8).Column(1).Text("Anzahl Umlenkrollen:").FontSize(fontSizeXXS);
                table.Cell().Row(8).Column(2).AlignRight().Text($"{ParameterDictionary["var_AnzahlUmlenkrollen"].Value} Stk").FontSize(fontSizeXXS);
                table.Cell().Row(9).Column(1).Text("Anzahl Umlenkrollen FK:").FontSize(fontSizeXXS);
                table.Cell().Row(9).Column(2).AlignRight().Text($"{ParameterDictionary["var_AnzahlUmlenkrollenFk"].Value} Stk").FontSize(fontSizeXXS);
                table.Cell().Row(10).Column(1).Text("Anzahl Umlenkrollen GGW:").FontSize(fontSizeXXS);
                table.Cell().Row(10).Column(2).AlignRight().Text($"{ParameterDictionary["var_AnzahlUmlenkrollenGgw"].Value} Stk").FontSize(fontSizeXXS);
                table.Cell().Row(11).Column(1).Text("Unterseilgewicht:").FontSize(fontSizeXXS);
                table.Cell().Row(11).Column(2).AlignRight().Text($"{ParameterDictionary["var_UnterseilGewicht"].Value}").FontSize(fontSizeXXS);
                table.Cell().Row(12).Column(1).Text("Frequenzumrichter:").FontSize(fontSizeXXS);
                table.Cell().Row(12).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Regler_Typ"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(13).Column(1).Text("Gebertyp des Motors:").FontSize(fontSizeXXS);
                table.Cell().Row(13).Column(2).AlignRight().Text(ParameterDictionary["var_MotorGeber"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(14).Column(1).ColumnSpan(2).PaddingTop(5).Text("UCM - Daten").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(15).Column(1).Text("Erkennungsweg in mm:").FontSize(fontSizeXXS);
                table.Cell().Row(15).Column(2).AlignRight().Text($"{ParameterDictionary["var_Erkennungsweg"].Value} mm").FontSize(fontSizeXXS);
                table.Cell().Row(16).Column(1).Text("Totzeit gesamt:").FontSize(fontSizeXXS);
                table.Cell().Row(16).Column(2).AlignRight().Text($"{ParameterDictionary["var_Totzeit"].Value} ms").FontSize(fontSizeXXS);
                table.Cell().Row(17).Column(1).Text("V Geschwindigkeitsdetektor:").FontSize(fontSizeXXS);
                table.Cell().Row(17).Column(2).AlignRight().Text($"{ParameterDictionary["var_Vdetektor"].Value} m/s").FontSize(fontSizeXXS);
            }
            else
            {
                table.Cell().Row(1).Column(1).ColumnSpan(2).Text("Daten Hydraulik").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(2).Column(1).Text("Tankgröße:").FontSize(fontSizeXXS);
                table.Cell().Row(2).Column(2).AlignRight().Text(ParameterDictionary["var_Antrieb"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(3).Column(1).Text("Ventilbezeichnung:").FontSize(fontSizeXXS);
                table.Cell().Row(3).Column(2).AlignRight().Text(ParameterDictionary["var_Hydraulikventil"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(4).Column(1).Text("Pumpenbezeichnung:").FontSize(fontSizeXXS);
                table.Cell().Row(4).Column(2).AlignRight().Text(ParameterDictionary["var_Pumpenbezeichnung"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(5).Column(1).Text("Hydraulikzylinder:").FontSize(fontSizeXXS);
                table.Cell().Row(5).Column(2).AlignRight().Text(ParameterDictionary["var_Hydraulikzylinder"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(6).Column(1).Text("Aufhängung:").FontSize(fontSizeXXS);
                table.Cell().Row(6).Column(2).AlignRight().Text($"{ParameterDictionary["var_AufhaengungsartRope"].Value} : 1").FontSize(fontSizeXXS);
                table.Cell().Row(7).Column(1).Text("Umlenkrollendurchmesser:").FontSize(fontSizeXXS);
                table.Cell().Row(7).Column(2).AlignRight().Text($"{ParameterDictionary["var_Umlenkrollendurchmesser"].Value} mm").FontSize(fontSizeXXS);
                table.Cell().Row(8).Column(1).Text("Frequenzumrichter:").FontSize(fontSizeXXS);
                table.Cell().Row(8).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Regler_Typ"].Value).FontSize(fontSizeXXS);
                table.Cell().Row(9).Column(1).ColumnSpan(2).PaddingTop(5).Text("UCM - Daten").FontSize(fontSizeXS).FontColor(borderColor).Bold();
                table.Cell().Row(10).Column(1).Text("Erkennungsweg in mm:").FontSize(fontSizeXXS);
                table.Cell().Row(10).Column(2).AlignRight().Text($"{ParameterDictionary["var_Erkennungsweg"].Value} mm").FontSize(fontSizeXXS);
                table.Cell().Row(11).Column(1).Text("Bremsweg Ventil:").FontSize(fontSizeXXS);
                table.Cell().Row(11).Column(2).AlignRight().Text("maximaler Bremsweg des Hydraulikventiles 750mm").FontSize(fontSizeXXS);
            }
        });
    }
}