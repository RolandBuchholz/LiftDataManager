...
public class SpezifikationDocument : PdfBaseDocument
{
    ...
    void CarFrameDetailData(IContainer container)
    {
        container.Table(table =>
        {
            ...
            table.Cell().Row(7).Column(1).ShowIf(isRopeLift).Text("Puffer Typ GGW:").FontSize(fontSizeXXS);
            table.Cell().Row(7).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_Puffertyp_GGW"].Value).FontSize(fontSizeXXS);
            ...
            table.Cell().Row(10).Column(1).ShowIf(isRopeLift).Text($"Gegengewicht kompl. (Ausgleich {ParameterDictionary["var_GGWNutzlastausgleich"].Value}):").FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_Gegengewichtsmasse"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(10).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(1).ShowIf(isRopeLift).Text("GGW-Rahmengewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_GGW_Rahmen_Gewicht"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(11).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(1).ShowIf(isRopeLift).Text("GGW-Füllungsgewicht:").FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_GGW_Fuellgewicht"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(12).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("kg").FontSize(fontSizeXXS);
            table.Cell().Row(13).Column(1).Text("Schienenlänge Fahrkorb:").FontSize(fontSizeXXS);
            table.Cell().Row(13).Column(2).AlignRight().Text(ParameterDictionary["var_Schienenlaenge"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(13).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(14).Column(1).Text(isRopeLift ? "Schienenlänge Gegengewicht:" : "Jochschienenlänge:").FontSize(fontSizeXXS);
            table.Cell().Row(14).Column(2).AlignRight().Text(ParameterDictionary["var_Hilfsschienenlaenge"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(14).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(15).Column(1).Text("Startschiene Fahrkorb:").FontSize(fontSizeXXS);
            table.Cell().Row(15).Column(2).AlignRight().Text(ParameterDictionary["var_Startschiene"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(15).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(16).Column(1).Text(isRopeLift ? "Startschiene Gegengewicht:" : "Startschiene Joch").FontSize(fontSizeXXS);
            table.Cell().Row(16).Column(2).AlignRight().Text(ParameterDictionary["var_HilfsschienenlaengeStartstueck"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(16).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(17).Column(1).Text("Fahrkorb Endstück:").FontSize(fontSizeXXS);
            table.Cell().Row(17).Column(2).AlignRight().Text(ParameterDictionary["var_Endschiene"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(17).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(18).Column(1).Text(isRopeLift ? "Gegengewicht Endstück:" : "Joch Endstück").FontSize(fontSizeXXS);
            table.Cell().Row(18).Column(2).AlignRight().Text(ParameterDictionary["var_HilfsschienenlaengeEndstueck"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(18).Column(3).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(19).Column(1).ColumnSpan(3).PaddingTop(3).Text("Seildaten").FontSize(fontSizeXS).FontColor(borderColor).Bold();
            table.Cell().Row(20).Column(1).ShowIf(isRopeLift).Text("Treibscheibendurchmesser:").FontSize(fontSizeXXS);
            table.Cell().Row(20).Column(2).ShowIf(isRopeLift).AlignRight().Text(ParameterDictionary["var_Treibscheibendurchmesser"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(20).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("mm").FontSize(fontSizeXXS);
            table.Cell().Row(21).Column(1).ColumnSpan(3).Text($"Tragseiltyp:   {ParameterDictionary["var_Tragseiltyp"].Value}").FontSize(fontSizeXXS);
            table.Cell().Row(22).Column(1).Text("Anzahl der Tragseile:").FontSize(fontSizeXXS);
            table.Cell().Row(22).Column(2).AlignRight().Text(ParameterDictionary["var_NumberOfRopes"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(22).Column(3).AlignLeft().PaddingLeft(2).Text("stk.").FontSize(fontSizeXXS);
            table.Cell().Row(23).Column(1).Text("Mindestbruchlast Tragseil:").FontSize(fontSizeXXS);
            table.Cell().Row(23).Column(2).AlignRight().Text(ParameterDictionary["var_Mindestbruchlast"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(23).Column(3).AlignLeft().PaddingLeft(2).Text("N").FontSize(fontSizeXXS);
            table.Cell().Row(24).Column(1).Text("Sicherheitsfaktor Tragseil:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(27).Column(1).ShowIf(isRopeLift).Text("Belastung unter GGW Schiene:").FontSize(fontSizeXXS);
            table.Cell().Row(27).Column(2).ShowIf(isRopeLift).AlignRight().Text($"({ParameterDictionary["var_Belastung_pro_Schiene_auf_Grundelement_GGW"].Value}) {ParameterDictionary["var_Belastung_pro_Schiene_auf_Grundelement_GGW_AZ"].Value}").FontSize(fontSizeXXS);
            table.Cell().Row(27).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("N").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(29).Column(1).ShowIf(isRopeLift).Text("Belastung unter GGW Puffer:").FontSize(fontSizeXXS);
            table.Cell().Row(29).Column(2).ShowIf(isRopeLift).AlignRight().Text($"({ParameterDictionary["var_Belastung_Pufferstuetze_auf_Grundelement_GGW"].Value}) {ParameterDictionary["var_Belastung_Pufferstuetze_auf_Grundelement_GGW_AZ"].Value}").FontSize(fontSizeXXS);
            table.Cell().Row(29).Column(3).ShowIf(isRopeLift).AlignLeft().PaddingLeft(2).Text("N").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(32).Column(1).Text(isRopeLift ? "Kraft Fx auf GGW-Schiene:" : "Kraft Fx auf Joch-Schiene:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(33).Column(1).Text(isRopeLift ? "Kraft Fy auf GGW-Schiene:" : "Kraft Fy auf Loch-Schiene:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(38).Column(3).AlignLeft().PaddingLeft(2).Text("V").FontSize(fontSizeXXS);
            table.Cell().Row(39).Column(1).Text("Leistung Motor:").FontSize(fontSizeXXS);
            table.Cell().Row(39).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Motor_Pr"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(39).Column(3).AlignLeft().PaddingLeft(2).Text("KW").FontSize(fontSizeXXS);
            table.Cell().Row(40).Column(1).Text("Bemessungsspannung Motor:").FontSize(fontSizeXXS);
            table.Cell().Row(40).Column(2).AlignRight().Text(ParameterDictionary["var_ZA_IMP_Motor_Ur"].Value).FontSize(fontSizeXXS);
            table.Cell().Row(40).Column(3).AlignLeft().PaddingLeft(2).Text("V").FontSize(fontSizeXXS);
            table.Cell().Row(41).Column(1).Text("Bemessungsstrom Motor:").FontSize(fontSizeXXS);
            ...
            table.Cell().Row(44).Column(1).Text("Max. Schmelzsicherung:").FontSize(fontSizeXXS);
            table.Cell().Row(44).Column(2).AlignRight().Text(maxFuse.ToString()).FontSize(fontSizeXXS);
            table.Cell().Row(44).Column(3).AlignLeft().PaddingLeft(2).Text("A").FontSize(fontSizeXXS);
        });
    }
