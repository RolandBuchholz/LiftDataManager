...
namespace LiftDataManager.Core.Migrations
{
    ...
    [Migration("20250912045337_Add_FanInstallation")]
    partial class Add_FanInstallation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.Abbreviation", b =>
                {
                    ...
                    b.ToTable("Abbreviations", (string)null);
                });
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.AntriebSteuerungNotruf.DriveSafetyBrake", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("DriveSafetyBrakes", (string)null);
                });
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.AntriebSteuerungNotruf.ZiehlAbeggDrive", b =>
                {
                    ...
                    b.Property<int>("DriveSafetyBrakeId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.Fahrkorb.OverspeedGovernor", b =>
                {
                    ...
                    b.Property<bool>("HasUCMPCertification")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.Kabine.FanInstallation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("FanInstallations", (string)null);
                });
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.ParameterDto", b =>
                {
                    ...
                    b.Property<bool>("CarDesignRelated")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("DispoPlanRelated")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("LiftPanelRelated")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.Tueren.LiftDoorTelescopicApron", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("LiftDoorTelescopicAprons", (string)null);
                });
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.Tueren.ShaftDoorInstallationTyp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ShaftDoorInstallationTyps", (string)null);
                });
            ...
            modelBuilder.Entity("LiftDataManager.Core.DataAccessLayer.Models.AntriebSteuerungNotruf.ZiehlAbeggDrive", b =>
                {
                    b.HasOne("LiftDataManager.Core.DataAccessLayer.Models.AntriebSteuerungNotruf.DriveSafetyBrake", "DriveSafetyBrake")
                        .WithMany("ZiehlAbeggDrives")
                        .HasForeignKey("DriveSafetyBrakeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DriveSafetyBrake");
                });
