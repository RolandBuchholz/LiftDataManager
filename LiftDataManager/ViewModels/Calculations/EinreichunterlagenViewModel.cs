...
public partial class EinreichunterlagenViewModel : DataViewModelBase, INavigationAwareEx, IRecipient<PropertyChangedMessage<string>>, IRecipient<RefreshModelStateMessage>
{
    ...
    public string DoorTyp => !string.IsNullOrWhiteSpace(ParameterDictionary["var_ShaftDoorDescriptionA"].Value) ? $"{ParameterDictionary["var_ShaftDoorDescriptionA"].Value} ({ParameterDictionary["var_ShaftDoorInstallationTypA"].Value})" : string.Empty;
